...
> **🚨 CRITICAL: DO NOT PUSH TO `narduk-enterprises/neon-sewer-raid` 🚨**
>
> This is a **read-only template repository**. Before writing ANY code, you MUST create your own repo:
>
> ```bash
> git clone https://github.com/narduk-enterprises/neon-sewer-raid-monorepo.git <project-name>
> cd <project-name>
> pnpm install 
> ```
>
> **Verify your remote** with `git remote -v` — it must NOT point to `narduk-enterprises/neon-sewer-raid`.
...
1. Clone the repository: `git clone https://github.com/narduk-enterprises/neon-sewer-raid-monorepo.git my-app`
...
If you are an agent building a new project inside a clone of this repository, **DO NOT COMMIT OR PUSH** directly back to `narduk-enterprises/neon-sewer-raid`. Verify the user has set up a new remote origin first.
